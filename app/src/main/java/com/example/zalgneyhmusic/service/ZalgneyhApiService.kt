...
interface ZalgneyhApiService {
    ...
    // User APIs
    @POST("users/follow")
    suspend fun toggleFollow(@Body body: Map<String, String>): Response<ApiResponse<Any>> // body: {"artistId": "..."}
    ...
    @GET("users/artists")
    suspend fun getFollowedArtists(): Response<ApiResponse<List<ArtistDTO>>>
